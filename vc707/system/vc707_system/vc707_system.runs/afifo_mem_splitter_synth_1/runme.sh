...
HD_PWD='/home/alessandro/Documents/embedded_prj/vc707/system/vc707_system/vc707_system.runs/afifo_mem_splitter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_mem_splitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_mem_splitter.tcl
