...
HD_PWD='/home/alessandro/Documents/embedded_prj/vc707/system/vc707_system/vc707_system.runs/bram_1024x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_1024x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_1024x64.tcl
