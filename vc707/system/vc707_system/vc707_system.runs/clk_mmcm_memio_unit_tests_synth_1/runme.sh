...
HD_PWD='/home/alessandro/Documents/embedded_prj/vc707/system/vc707_system/vc707_system.runs/clk_mmcm_memio_unit_tests_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_mmcm_memio_unit_tests.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_mmcm_memio_unit_tests.tcl
