...
HD_PWD='/home/alessandro/Documents/embedded_prj/vc707/system/vc707_system/vc707_system.runs/bram_128x80_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_128x80.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_128x80.tcl
