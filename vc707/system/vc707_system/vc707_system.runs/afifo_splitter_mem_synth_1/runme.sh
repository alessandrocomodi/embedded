...
HD_PWD='/home/alessandro/Documents/embedded_prj/vc707/system/vc707_system/vc707_system.runs/afifo_splitter_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_splitter_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_splitter_mem.tcl
